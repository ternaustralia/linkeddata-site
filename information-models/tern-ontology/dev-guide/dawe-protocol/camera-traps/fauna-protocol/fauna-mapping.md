...
The mapping of the source app data to the TERN Ontology on this page is applicable to the [Fauna plot protocol](https://linked.data.gov.au/def/nrm/a2afccd5-766e-44bc-98c1-f27aae26727f) protocol in [Camera traps](https://linked.data.gov.au/def/nrm/f0123418-c565-45a6-be01-c5c332c727e5) module.

## Conceptual modelling

The Camera traps - Fauna protocol records data about the site for the following feature types:
...
The Fauna plot protocol includes the procedures and guidelines for the standardized deployment and recovery or redeployment of camera traps in a fauna plot, including standards for camera make, model and settings, camera placement and orientation, site preparation, bait station installation, deployment period, and entering the data directly into the App.
...
The `point_id` key maps to the attribute `camera trap point` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to deployment by `tern:hasAttribute`.
...
The `camera_trap_mount` key maps to the attribute `camera trap mount` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to deployment by `tern:hasAttribute`.
...
The `features` key maps to the attribute `feature` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to deployment by `tern:hasAttribute`.
...
The `distance_to_feature` key maps to the attribute `distance to feature` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to deployment by `tern:hasAttribute`.
...
The `bait_container_height` key maps to the attribute `bait container height` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to deployment by `tern:hasAttribute`.
...
The `camera_lure_type` key maps to the attribute `lure type` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to deployment by `tern:hasAttribute`.
...
The `camera_lure_variety` key maps to the attribute `lure variety` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to deployment by `tern:hasAttribute`.
...
The `SD_card_number` key maps to the attribute `sd card id` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to sampler by `tern:hasAttribute`.
...
The `camera_trap_height` key maps to the attribute `camera trap height` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to deployment by `tern:hasAttribute`.
...
The `camera_trap_direction` key maps to the attribute `camera trap direction` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to deployment by `tern:hasAttribute`.
...
The `camera_trap_angle` key maps to the attribute `camera trap angle` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to deployment by `tern:hasAttribute`.
...
The `detection_angle` key maps to the attribute `camera trap detection angle` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to deployment by `tern:hasAttribute`.
...
The `slope` key maps to the attribute `slope` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to location by `tern:hasAttribute`.
...
The `aspect` key maps to the attribute `aspect` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to location by `tern:hasAttribute`.
...
The `deployment_notes` key maps to the attribute `deployment motes` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to deployment by `tern:hasAttribute`.
...
The `feature` key maps to the attribute `feature` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to deployment by `tern:hasAttribute`.
...
The `camera_make` key maps to the attribute `camera trap make` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to sampler by `tern:hasAttribute`.
...
The `camera_model` key maps to the attribute `camera trap model` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to sampler by `tern:hasAttribute`.
...
The `camera_year` key maps to the attribute `camera trap year` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to sampler by `tern:hasAttribute`.
...
The `camera_illumination_type` key maps to the attribute `illumination` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to sampler by `tern:hasAttribute`.
...
The `camera_activation_mechanism` key maps to the attribute `activation mechanism` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to sampler by `tern:hasAttribute`.
...
The `camera_trigger_speed` key maps to the attribute `trigger speed` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to sampler by `tern:hasAttribute`.
...
The `operational_status` key maps to the attribute `operational status` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to deployment by `tern:hasAttribute`.
...
The `number_of_images` key maps to the attribute `number of images` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to deployment by `tern:hasAttribute`.
...
The `reequipping_notes` key maps to the attribute `redeployment motes` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to deployment by `tern:hasAttribute`.
...
The `point_id` key maps to the attribute `camera trap point` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to recovery by `tern:hasAttribute`.
...
The `operational_status` key maps to the attribute `operational status` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to recovery by `tern:hasAttribute`.
...
The `number_of_images` key maps to the attribute `number of images` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to recovery by `tern:hasAttribute`.
...
The `retrieval_notes` key maps to the attribute `recovery motes` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to retrieval by `tern:hasAttribute`.
...
The `camera_media_type` key maps to the attribute `media type` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to sampler by `tern:hasAttribute`.
...
The `quite_period` key maps to the attribute `camera settings- quite period` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to sampler by `tern:hasAttribute`.
...
The `sensor_sensitivity` key maps to the attribute `camera settings- sensor sensitivity` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to sampler by `tern:hasAttribute`.
...
The `unit_of_temperature` key maps to the attribute `camera settings- unit of temperature` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to sampler by `tern:hasAttribute`.
...
The `battery_type` key maps to the attribute `camera settings- battery type` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to sampler by `tern:hasAttribute`.
...
The `images_per_trigger` key maps to the attribute `camera settings- pictures per trigger` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to deployment by `tern:hasAttribute`.
...
The `image_interval` key maps to the attribute `camera settings- picture interval` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to sampler by `tern:hasAttribute`.
...
The `video_resolution` key maps to the attribute `camera settings- image resolution` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to sampler by `tern:hasAttribute`.
...
The `night_mode_shutter_speed` key maps to the attribute `camera settings- night mode` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to sampler by `tern:hasAttribute`.
...
The `user_label` key maps to the attribute `camera settings- user label` in [Camera traps module - fauna protocol Attributes](https://linked.data.gov.au/def/nrm/637a0757-d63b-448b-a518-c99902e3b242), and is linked to deployment by `tern:hasAttribute`.
...
The specification requirements of observations in `Camera traps - fauna protocol` are in [Camera Traps - Fauna protocol Conformance Class Requirements](https://ternaustralia.github.io/dawe-rlp-spec/#camera_traps_fauna_protocol_conformance_class_requirements).

Validator is [Camera traps - fauna protocol shapes](https://github.com/ternaustralia/dawe-rlp-spec/blob/main/shapes/camera-traps/camera-traps-fauna-protocol-shapes/shapes.ttl).
...
Save the [Camera traps - fauna shapes](https://github.com/ternaustralia/dawe-rlp-spec/blob/main/shapes/camera-traps/camera-traps-fauna-protocol-shapes/shapes.ttl) in a file named `camera-traps-fauna-shapes.ttl` in the Turtle RDF format.

Assuming you have a file named `data.ttl` in the Turtle RDF format and **it has observations for Camera traps - fauna protocol**, run the following command to validate the data:

```bash
pyshacl -s camera-traps-fauna-shapes.ttl -m -i rdfs -a -j -f human data.ttl
```
...
Save the [habitat description shapes](https://github.com/ternaustralia/dawe-rlp-spec/blob/main/shapes/camera-traps/camera-traps-fauna-protocol-shapes/habitat-description/shapes.ttl) in a file named `habitat-description-shapes.ttl` in the Turtle RDF format.

Assuming you have a file named `data.ttl` in the Turtle RDF format and **it has observations for habitat description in Camera traps - fauna protocol**, run the following command to validate the data:
