...
The mapping of the source app data to the TERN Ontology on this page is applicable to the [Array protocol](https://linked.data.gov.au/def/nrm/1a6953e4-a830-41f8-9cfd-11ead4dd6bc2) protocol in [Camera traps](https://linked.data.gov.au/def/nrm/f0123418-c565-45a6-be01-c5c332c727e5) module.

## Conceptual modelling

The Camera traps - Array protocol records data about the site for the following feature types:
