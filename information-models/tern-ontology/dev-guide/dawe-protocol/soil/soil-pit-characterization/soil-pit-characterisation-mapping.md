...
<https://example.com/site/1>
    ...
    geo:hasGeometry [
        ...
        wgs84:lat "-29.920857"^^xsd:double ;
        wgs84:long "151.242407"^^xsd:double ;
    ] ;
.
...
<https://example.com/observation/australian-soil-classification-order/1>
    a tern:Observation ;
...
<https://example.com/observation/r-horizon-depth/1>
    ...
    sosa:hasResult [
            a tern:Float ;
            rdf:value "0.88"^^xsd:float ;
            tern:unit <http://qudt.org/vocab/unit/M>
        ] ;
    sosa:hasSimpleResult "0.88"^^xsd:float ;
...
<https://example.com/observation/soil-ph/1>
    ...
    sosa:hasResult [
            a tern:Float ;
            rdf:value "7.0"^^xsd:float ;
            tern:unit <http://qudt.org/vocab/unit/PH>
        ] ;
    sosa:hasSimpleResult "7.0"^^xsd:float ;
...
<https://example.com/observation/soil-pit-depth/1>
    ...
    sosa:hasResult [
            a tern:Float ;
            rdf:value "101.12"^^xsd:float ;
            tern:unit <http://qudt.org/vocab/unit/CentiM>
        ] ;
    sosa:hasSimpleResult "101.12"^^xsd:float ;
