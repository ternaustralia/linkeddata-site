const exampleData = {
  // cover class
  "https://linked.data.gov.au/def/nrm/f3e6e19b-ba79-4260-b493-8a2561033f9b": {
    "@type": [
    ...
    value: {
      "@id":
        "https://linked.data.gov.au/def/nrm/13131d7c-55d8-53e8-938c-f40015309534",
      "@type": "@id",
    },
  },
  // cover
  ...
  "https://linked.data.gov.au/def/nrm/58e4aba5-78c3-4361-b08a-ae39a93c8cb0": {
    ...
    value: {
      "@id":
        "https://linked.data.gov.au/def/nrm/0b764595-db65-5ddc-8591-8d9c653a4a21",
      "@type": "@id",
    },
  },
  // landform element
  "https://linked.data.gov.au/def/nrm/9d4f8a2d-8e77-42dd-857b-0ecbc9c85696": {
    ...
    value: {
      "@id":
        "https://linked.data.gov.au/def/nrm/11ccf134-21ac-5215-b3ee-39b84953837b",
      "@type": "@id",
    },
  },
  // slope
  ...
  // surface strew size
  "https://linked.data.gov.au/def/nrm/3eeef779-d4d9-4019-9543-be0abe54cc5c": {
    "@type": [
      "https://w3id.org/tern/ontologies/tern/Concept",
      "https://w3id.org/tern/ontologies/tern/Value",
    ],
    value: {
      "@id":
        "https://linked.data.gov.au/def/nrm/4147fa32-4fdd-5b84-9c31-0fcadfd6ad93",
      "@type": "@id",
    },
  },
  // surface strew lithology
  "https://linked.data.gov.au/def/nrm/6ee380ca-e9dc-4a9b-91c3-758b54e751eb": {
    "@type": [
      "https://w3id.org/tern/ontologies/tern/Concept",
      "https://w3id.org/tern/ontologies/tern/Value",
    ],
    value: {
      "@id":
        "https://linked.data.gov.au/def/nrm/0ac1055d-cf12-5575-9a37-b9d380dacd42",
      "@type": "@id",
    },
  },
  // outcropt lithology
  "https://linked.data.gov.au/def/nrm/5af5cef1-179c-4bae-9037-42196668deff": {
    ...
    value: {
      "@id":
        "https://linked.data.gov.au/def/nrm/120314f6-bdfd-5cc1-83e0-dfbc6c600386",
      "@type": "@id",
    },
  },
  ...
  "https://linked.data.gov.au/def/nrm/103f26cb-0194-45d2-8b1a-e18e1da6df2b": {
    ...
    value: {
      "@id":
        "https://linked.data.gov.au/def/nrm/0e6077ea-8f45-5219-9247-6316c84156bf",
      "@type": "@id",
    },
  },
  // climatic condition
  "https://linked.data.gov.au/def/nrm/dee23df7-4445-424f-b361-b2e0182be950": {
    "@type": [
      "https://w3id.org/tern/ontologies/tern/Concept",
      "https://w3id.org/tern/ontologies/tern/Value",
    ],
    value: {
      "@id":
        "https://linked.data.gov.au/def/nrm/7933a4c8-1fd2-51f8-b71e-11d690535808",
      "@type": "@id",
    },
  },
  // disturbance
  "https://linked.data.gov.au/def/nrm/632e4c3c-0e73-4b3d-b1d6-7b38897da5e8": {
    ...
    value: {
      "@id":
        "https://linked.data.gov.au/def/nrm/2cef9075-c7d6-52d5-9c46-c951c37790ff",
      "@type": "@id",
    },
  },
  ...
  "https://linked.data.gov.au/def/nrm/909557e9-782f-45ea-8e89-8cf17a2c6ca6": {
    "@type": [
      "https://w3id.org/tern/ontologies/tern/Concept",
      "https://w3id.org/tern/ontologies/tern/Value",
    ],
  ...
  "https://linked.data.gov.au/def/nrm/dd1769b9-c475-4732-915c-9b890a8d5f65": {
    ...
    value: {
      "@id":
        "https://linked.data.gov.au/def/nrm/10f93cb6-c6af-5c70-941b-01bfde3ac873",
      "@type": "@id",
    },
  },
  // growth stage
  "https://linked.data.gov.au/def/nrm/fcfda2f7-84f0-4c26-9f80-c051d129a094": {
    ...
    value: {
      "@id":
        "https://linked.data.gov.au/def/nrm/2ce92e92-ea69-5f3e-85bf-b3063da0bddd",
      "@type": "@id",
    },
  },
  // height class
  "https://linked.data.gov.au/def/nrm/242d081b-b3f4-4206-bc39-7aa42e9972ee": {
    "@type": [
      "https://w3id.org/tern/ontologies/tern/Concept",
      "https://w3id.org/tern/ontologies/tern/Value",
    ],
    value: {
      "@id":
        "https://linked.data.gov.au/def/nrm/35c8d4ba-5474-5a9a-ba66-d5792e7eb907",
    },
  },
  // species cover
  ...
  "http://linked.data.gov.au/def/tern-cv/abb0ee19-b2e8-42f3-8a25-d1f39ca3ebc3":
    {
      ...
      value: {
        // TODO: change
        "@id": "https://linked.data.gov.au/def/nrm/life-stage/3",
      },
    },
  // fire history
  "https://linked.data.gov.au/def/nrm/cf1aef8a-a782-4480-9c41-a7f6d170d7fc": {
    ...
    value: {
      // TODO: change
      "@id":
        "https://linked.data.gov.au/def/nrm/79155721-cb28-5e1e-98ba-fcf6a436f339",
    },
  },
  ...
  // slope type
  "https://linked.data.gov.au/def/nrm/132a1452-4fd7-473c-956b-3183dd315b67": {
    "@type": [
      "https://w3id.org/tern/ontologies/tern/Concept",
      "https://w3id.org/tern/ontologies/tern/Value",
    ],
    value: {
      "@id":
        "https://linked.data.gov.au/def/nrm/0f06cf3a-681c-5e3d-8d60-e2663d2193ed",
    },
  },
};
