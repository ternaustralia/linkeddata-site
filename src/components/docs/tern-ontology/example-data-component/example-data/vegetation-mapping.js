const exampleData = {
  ...
  "https://linked.data.gov.au/def/nrm/632e4c3c-0e73-4b3d-b1d6-7b38897da5e8": {
    ...
    value: {
      "@id":
        "https://linked.data.gov.au/def/nrm/2ce5904f-31f0-502f-b5f8-2909083778f3",
      "@type": "@id",
    },
  },
  ...
  "https://linked.data.gov.au/def/nrm/fcfda2f7-84f0-4c26-9f80-c051d129a094": {
    ...
    value: {
      "@id":
        "https://linked.data.gov.au/def/nrm/3bfaa642-0832-5aa8-a985-e1e4679c62ac",
      "@type": "@id",
    },
  },
  // homogeneity measure
  ...
  "https://linked.data.gov.au/def/nrm/cbea81bc-2447-4c78-bab8-54d6637e2178": {
    "@type": [
      "https://w3id.org/tern/ontologies/tern/QuantitativeMeasure",
      "https://w3id.org/tern/ontologies/tern/Value",
    ],
